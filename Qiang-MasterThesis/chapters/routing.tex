...
本章主要研究了在有向Kleinberg小世界网络中复杂路由的研究，网络模型的设定和Kleinberg最初提出分散式路由时的网络模型一致\upcite{Kleinberg2000small}。
...
这样可以在证明中使用延迟选择原则\upcite{Motwani1995randomized}，和\upcite{Kleinberg2000small}在证明分散式路由中使用的原则一样。
